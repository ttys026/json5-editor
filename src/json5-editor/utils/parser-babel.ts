...
function C() {
  E &&
    f &&
    ((E = !1), f.length ? (y = f.concat(y)) : (A = -1), y.length && x());
}
function x() {
  if (!E) {
    var t = m(C);
...
var j = R(function(t, e) {
  ...
  o('NUMERICIDENTIFIER', '0|[1-9]\\d*'),
    ...
    o(
      ...
      '(?:'
        .concat(i[n.NUMERICIDENTIFIER], '|')
        .concat(i[n.NONNUMERICIDENTIFIER], ')'),
    ),
    o(
    ...
    o(
      'PRERELEASE',
      '(?:-('
        .concat(i[n.PRERELEASEIDENTIFIER], '(?:\\.')
        .concat(i[n.PRERELEASEIDENTIFIER], ')*))'),
    ),
    o(
      'PRERELEASELOOSE',
    ...
    o(
      'BUILD',
      '(?:\\+('
        .concat(i[n.BUILDIDENTIFIER], '(?:\\.')
        .concat(i[n.BUILDIDENTIFIER], ')*))'),
    ),
    o(
      'FULLPLAIN',
      'v?'
        .concat(i[n.MAINVERSION])
        .concat(i[n.PRERELEASE], '?')
        .concat(i[n.BUILD], '?'),
    ),
    ...
    o(
      'LOOSEPLAIN',
      '[v=\\s]*'
        .concat(i[n.MAINVERSIONLOOSE])
        .concat(i[n.PRERELEASELOOSE], '?')
        .concat(i[n.BUILD], '?'),
    ),
    ...
    o(
      ...
      '(\\s*)'
        .concat(i[n.GTLT], '\\s*(')
        .concat(i[n.LOOSEPLAIN], '|')
        .concat(i[n.XRANGEPLAIN], ')'),
      !0,
    ),
    (e.comparatorTrimReplace = '$1$2$3'),
    o(
      'HYPHENRANGE',
      '^\\s*('.concat(i[n.XRANGEPLAIN], ')') +
        '\\s+-\\s+' +
        '('.concat(i[n.XRANGEPLAIN], ')') +
        '\\s*$',
    ),
    o(
      'HYPHENRANGELOOSE',
      '^\\s*('.concat(i[n.XRANGEPLAINLOOSE], ')') +
        '\\s+-\\s+' +
        '('.concat(i[n.XRANGEPLAINLOOSE], ')') +
        '\\s*$',
    ),
    o('STAR', '(<|>)?=?\\s*\\*'),
    o('GTE0', '^\\s*>=\\s*0.0.0\\s*$'),
...
class K {
  ...
  compare(t) {
    if (
      (O('SemVer.compare', this.version, this.options, t), !(t instanceof K))
    ) {
  ...
  comparePre(t) {
    ...
    do {
      const s = this.prerelease[e],
        r = t.prerelease[e];
      if ((O('prerelease compare', e, s, r), void 0 === s && void 0 === r))
        return 0;
...
var lt = {
  getSupportInfo: function({
    ...
    const i = ct.split('-', 1)[0],
      ...
      a = ((o = Object.assign({}, ...t.map(({ options: t }) => t), pt)),
      (u = 'name'),
            ...
            Array.isArray(e.default) &&
              (e.default =
                1 === e.default.length
                  ...
                  : e.default
                      .filter(h)
                      .sort((t, e) => ht.compare(e.since, t.since))[0].value),
    ...
    function c(t) {
      return (
        s || !('deprecated' in t) || (t.deprecated && ht.lt(i, t.deprecated))
      );
    }
  },
};
...
function xt(t, e) {
  return (
    !1 !== e && ('/' === t.charAt(e) && '/' === t.charAt(e + 1) ? At(t, e) : e)
  );
}
function Ft(t, e, s) {
...
function Bt(t, e) {
  ...
  if (s.includes(n.quote) || s.includes(a.quote)) {
    o =
      (s.match(n.regex) || []).length > (s.match(a.regex) || []).length
        ? a.quote
        : n.quote;
  }
  return o;
  ...
  Yt = R(function(t) {
    !(function() {
      ...
      for (
        ...
        i[a] =
          (a >= 97 && a <= 122) || (a >= 65 && a <= 90) || 36 === a || 95 === a;
...
function Ve(t) {
  return (
    ...
    ((t.comments &&
      t.comments.length > 0 &&
      t.comments.some(t => qe(t) && !t.unignore)) ||
      t.prettierIgnore)
  );
}
function ze(t) {
...
var He = {
    ...
    if (t) {
      ...
      switch (t.type) {
        ...
        case 'ClassPrivateMethod': {
          ...
          return (
            !e && 'get' !== t.kind && 'set' !== t.kind && !(!t.computed && !s)
          );
        }
  ...
  hasFlowShorthandAnnotationComment: function(t) {
    return (
      ...
      t.trailingComments &&
      pe(t.trailingComments[0]) &&
      oe.test(t.trailingComments[0].value)
    );
  },
  ...
  hasNewlineBetweenOrAfterDecorators: function(t, e) {
    return (
      se(e.originalText, ie(t.decorators[0]), ne(te(t.decorators))) ||
  ...
  isNgForOf: function(t, e, s) {
    return (
      ...
      'of' === t.key.name &&
      1 === e &&
      'NGMicrosyntaxLet' === s.body[0].type &&
      null === s.body[0].value
    );
  },
  isNumericLiteral: me,
...
function fs(t, e) {
  ...
  if (
    s &&
    ('Identifier' === s.type || 'AssignmentPattern' === s.type) &&
    r &&
    xs(r) &&
    ')' === Ke(e, t, us)
  )
    ...
    return (
      ...
      (function(t) {
        ...
        if (s && ('UnionTypeAnnotation' === s.type || 'TSUnionType' === s.type))
          return (
            ss(t) && ((r.prettierIgnore = !0), (t.unignore = !0)),
            !!e && (Ye(e, t), !0)
          );
        r &&
  ...
  handleRemainingComment: function(t, e, s, r, i) {
    return !!(
      ...
      (function(t) {
        ...
        if (
          s &&
          ('ObjectProperty' === s.type || 'Property' === s.type) &&
          s.shorthand &&
          s.key === e &&
      ...
      (function(t) {
        ...
        if (r && 'TSTypeParameter' === r.type && r.name)
          return $e(r.name, t), !0;
      ...
      (function(t, e) {
        ...
        if (
          !r &&
          s &&
          ('TSMethodSignature' === s.type ||
            'TSDeclareFunction' === s.type ||
...
const {
    getLast: bs,
    getNextNonSpaceNonCommentCharacter: Ps,
    getShebang: Ts,
  } = It,
...
var Os = function(e, s) {
    if (
      ...
      const {
        esTreeNodeToTSNodeMap: r,
        tsNodeToESTreeNodeMap: i,
      } = s.tsParseResult;
      e = vs(e, e => {
        const s = r.get(e);
        if (!s) return;
      ...
      (e = vs(e, e => {
        ...
        (e = vs(e, e => {
          if ('ParenthesizedExpression' === e.type) {
            ...
            if (!t.has(r))
              return (
                (s.extra = Object.assign({}, s.extra, { parenthesized: !0 })), s
              );
          }
        }));
    }
    ...
    (c.parenR.updateContext = c.braceR.updateContext = function() {
      ...
      (c.backQuote.updateContext = function() {
        this.curContext() === T.template
          ...
          : this.state.context.push(T.template),
          (this.state.exprAllowed = !1);
      }),
          ...
          class extends t {
            ...
            isValidDirective(t) {
              ...
              return (
                ...
                !(null == (e = t.expression.extra) ? void 0 : e.parenthesized)
              );
            }
            stmtToDirective(t) {
            ...
            parseSubscript(t, e, s, r, i) {
              ...
              if (i.optionalChainMember) {
                if (
                  ...
                  return (
                    (t.expression = n), this.finishNode(t, 'ChainExpression')
                  );
                }
              } else
            ...
            jsxReadToken() {
              ...
              for (;;) {
                if (this.state.pos >= this.length)
                  throw this.raise(this.state.start, st.UnterminatedJsxContent);
          ...
          class extends t {
            ...
            flowParseDeclareExportDeclaration(t, e) {
              if ((this.expect(c._export), this.eat(c._default)))
                return (
                  this.match(c._function) || this.match(c._class)
            ...
            flowParseFunctionTypeParam() {
              ...
              const r = this.startNode(),
                i = this.lookahead();
              return (
                i.type === c.colon || i.type === c.question
            ...
            flowParseFunctionTypeParams(t = []) {
              ...
              for (; !this.match(c.parenR) && !this.match(c.ellipsis); )
                t.push(this.flowParseFunctionTypeParam()),
                  this.match(c.parenR) || this.expect(c.comma);
              return (
                this.eat(c.ellipsis) && (e = this.flowParseFunctionTypeParam()),
                { params: t, rest: e }
              );
            }
            ...
            eatExportStar(t) {
              return (
                ...
                (!(
                  !this.isContextual('type') || this.lookahead().type !== c.star
                ) &&
            ...
            parseImportSpecifier(t) {
              ...
              if (
                ...
                null !== i &&
                (this.match(c.name) || this.state.type.keyword)
              )
            ...
            parseMaybeAssign(t, e, s) {
              ...
              if (
                ...
                if (
                  ((n = this.state.clone()),
                  (i = this.tryParse(() => super.parseMaybeAssign(t, e, s), n)),
                  !i.error)
                )
                  return i.node;
            ...
            flowEnumMembers({ enumName: t, explicitType: e }) {
              ...
              for (; !this.match(c.braceR); ) {
                ...
                switch (((i.id = n), a.type)) {
                  case 'boolean':
                    this.flowEnumCheckExplicitTypeMismatch(a.pos, u, 'boolean'),
                      (i.init = a.value),
                    ...
                    break;
                  case 'number':
                    this.flowEnumCheckExplicitTypeMismatch(a.pos, u, 'number'),
                      (i.init = a.value),
                    ...
                    break;
                  case 'string':
                    this.flowEnumCheckExplicitTypeMismatch(a.pos, u, 'string'),
                      (i.init = a.value),
        ...
        typescript: t =>
          class extends t {
            ...
            tsParseModifiers(t, e) {
              for (;;) {
                ...
                Object.hasOwnProperty.call(t, r) &&
                  this.raise(s, dt.DuplicateModifier, r),
                  (t[r] = !0);
              }
            }
            ...
            tsParseBracketedList(t, e, s, r) {
              ...
              return (
                s ? this.expect(c.bracketR) : this.expectRelational('>'), i
              );
            }
            tsParseImportType() {
              const t = this.startNode();
            ...
            tsParseSignatureMember(t, e) {
              return (
                this.tsFillSignature(c.colon, e),
            ...
            tsParsePropertyOrMethodSignature(t, e) {
              ...
              }
              {
                const t = s;
                return (
                  this.tsFillSignature(c.colon, t),
                  this.tsParseTypeMemberSemicolon(),
            ...
            tsParseFunctionOrConstructorType(t) {
              const e = this.startNode();
              return (
                'TSConstructorType' === t && this.expect(c._new),
            ...
            tsSkipParameterStart() {
              ...
              if (this.match(c.bracketL)) {
                let t = 1;
                for (this.next(); t > 0; )
                  this.match(c.bracketL) ? ++t : this.match(c.bracketR) && --t,
                    this.next();
                return !0;
              }
              return !1;
            ...
            tsIsUnambiguouslyStartOfFunctionType() {
              ...
              if (this.tsSkipParameterStart()) {
                if (
                  ...
                  return !0;
                if (this.match(c.parenR) && (this.next(), this.match(c.arrow)))
                  return !0;
              }
              return !1;
            }
            ...
            tsParseHeritageClause(t) {
              ...
              return (
                s.length || this.raise(e, dt.EmptyHeritageClauseType, t), s
              );
            }
              ...
              return (
                ...
                (t.typeAnnotation = this.tsInType(() => {
                  if (
                    ...
                    const t = this.startNode();
                    return (
                      this.next(), this.finishNode(t, 'TSIntrinsicKeyword')
                    );
                  }
            ...
            parseSubscript(t, e, s, r, i) {
              if (!this.hasPrecedingLineBreak() && this.match(c.bang)) {
                ...
                const r = this.startNodeAt(e, s);
                return (
                  (r.expression = t), this.finishNode(r, 'TSNonNullExpression')
                );
              }
            ...
            parseExprOp(t, e, s, r) {
              if (
                ...
                return (
                  (i.typeAnnotation = n || this.tsNextThenParseType()),
            ...
            parseExport(t) {
              ...
              return (
                this.isContextual('type') && this.lookahead().type === c.braceL
            ...
            parseArrow(t) {
              if (this.match(c.colon)) {
                const e = this.tryParse(t => {
                  ...
                  return (
                    (!this.canInsertSemicolon() && this.match(c.arrow)) || t(),
                    e
                  );
                });
                if (e.aborted) return;
              ...
              for (let e = 0; e < t.length; e++) {
                ...
                if (s)
                  switch (s.type) {
                    ...
                    case 'TSTypeAssertion':
                      this.state.maybeInArrowParameters
                        ? this.raise(s.start, dt.UnexpectedTypeCastInParameter)
                        : (t[e] = this.typeCastToParameter(s));
                  }
              }
        ...
        placeholders: t =>
          class extends t {
            ...
            parseClass(t, e, s) {
              ...
              if (n)
                if (
                  this.match(c._extends) ||
                  this.match(c.placeholder) ||
                  this.match(c.braceL)
                )
                  t.id = n;
                else {
    ...
    class _t {
      ...
      usePrivateName(t, e) {
        ...
        for (let e = 0, r = this.stack; e < r.length; e++)
          if (((s = r[e]), s.privateNames.has(t))) return;
        s
    ...
    class jt extends class extends class extends class extends class extends class extends class extends class extends class extends class {
      ...
      adjustCommentsAfterTrailingComma(t, e, s) {
        ...
        for (let e = 0; e < this.state.leadingComments.length; e++) {
          ...
          r.end < t.end
            ? (n.push(r), s || (this.state.leadingComments.splice(e, 1), e--))
      ...
      processComment(t) {
        ...
        if (((this.state.commentPreviousNode = t), i))
          if (i.length && i[0].start >= t.start && F(i).end <= t.end)
            t.innerComments = i;
          else {
            ...
            t === this.state.start
              ...
              : (function(t, e) {
                  let s,
                    r = 1,
                    i = 0;
                  for (f.lastIndex = 0; (s = f.exec(t)) && s.index < e; )
                    r++, (i = f.lastIndex);
                  return new C(r, e - i);
                })(this.input, t)),
          e
      ...
      next() {
        this.isLookahead ||
          ...
          this.options.tokens && this.pushToken(new Tt(this.state))),
      ...
      setStrict(t) {
        if (
          ((this.state.strict = t), this.match(c.num) || this.match(c.string))
        ) {
          for (
      ...
      readToken_numberSign() {
        ...
        if (e >= 48 && e <= 57)
          throw this.raise(this.state.pos, g.UnexpectedDigitAfterHash);
      ...
      readToken_eq_excl(t) {
        ...
        if (61 !== e)
          return 61 === t && 62 === e
            ? ((this.state.pos += 2), void this.finishToken(c.arrow))
      ...
      readRegexp() {
        ...
        for (; this.state.pos < this.length; ) {
          ...
          if (gt.has(t))
            i.indexOf(t) > -1 &&
              this.raise(this.state.pos + 1, g.DuplicateRegExpFlags);
          else {
            if (!O(e) && 92 !== e) break;
          ...
          if (95 !== e) {
            if (
              ...
              if (this.options.errorRecovery && h <= 9)
                (h = 0),
                  this.raise(this.state.start + i + 2, g.InvalidDigit, t);
              else {
                if (!s) break;
                (h = 0), (o = !0);
              }
            ...
            (-1 === a.indexOf(e) ||
              ...
              n.indexOf(e) > -1 ||
              Number.isNaN(e)) &&
              this.raise(this.state.pos, g.UnexpectedNumericSeparator),
              r ||
                this.raise(this.state.pos, g.NumericSeparatorInEscapeSequence),
              ++this.state.pos;
          }
        }
      ...
      readTmplToken() {
        ...
        for (;;) {
          if (this.state.pos >= this.length)
            throw this.raise(this.state.start, g.UnterminatedTemplate);
          const r = this.input.charCodeAt(this.state.pos);
          if (
            96 === r ||
      ...
      readEscapedChar(t) {
        ...
        switch ((++this.state.pos, s)) {
          ...
          case 57:
            if (t) return null;
            this.state.strict &&
              this.raise(this.state.pos - 1, g.StrictNumericEscape);
          default:
            if (s >= 48 && s <= 55) {
        ...
        for (; this.state.pos < this.length; ) {
          ...
          if (O(r)) this.state.pos += r <= 65535 ? 1 : 2;
            ...
            if (92 !== r) break;
            {
              ...
              null !== n &&
                (i(n) || this.raise(r, g.EscapedCharNotAnIdentifier),
      ...
      checkKeywordEscapes() {
        ...
        t &&
          ...
          this.raise(this.state.start, g.InvalidEscapedReservedWord, t);
      }
      braceIsBlock(t) {
        const e = this.curContext();
        return (
          ...
          case 'ObjectExpression':
            ...
            for (let e = 0, s = t.properties.length, r = s - 1; e < s; e++) {
              ...
              this.toAssignableObjectExpressionProp(s, n),
                n &&
                  'RestElement' === s.type &&
                  (null == (i = t.extra) ? void 0 : i.trailingComma) &&
      ...
      parseBindingList(t, e, s, r) {
        ...
        let n = !0;
        for (; !this.eat(t); )
          if ((n ? (n = !1) : this.expect(c.comma), s && this.match(c.comma)))
            i.push(null);
          else {
            if (this.eat(t)) break;
            ...
            }
            {
              ...
              for (
                ...
                this.raise(this.state.start, g.UnsupportedParameterDecorator);
                this.match(c.at);
      ...
      checkLVal(t, e = 64, s, r, i, n = !1) {
        switch (t.type) {
          case 'Identifier':
            if (
              (this.state.strict &&
                (n ? H(t.name, this.inModule) : z(t.name)) &&
                this.raise(
                  t.start,
                  e === D
            ...
            i && 'let' === t.name && this.raise(t.start, g.LetInLexicalBinding),
        ...
        if ('__proto__' === ('Identifier' === i.type ? i.name : i.value)) {
          ...
          s.used &&
            (r
              ...
              : this.raise(i.start, g.DuplicateProto)),
            (s.used = !0);
        }
      }
      ...
      getExpression() {
        ...
        return (
          this.match(c.eof) || this.unexpected(),
      ...
      parseExprOp(t, e, s, r) {
        ...
        if (
          null != i &&
          (this.prodParam.hasIn || !this.match(c._in)) &&
          i > r
        ) {
          ...
          if (
            ...
            throw this.raise(this.state.start, g.MixingCoalesceWithLogical);
      ...
      parseMember(t, e, s, r, i) {
        ...
        return (
          'PrivateName' === o.type &&
            ('Super' === n.object.type && this.raise(e, g.SuperPrivateField),
            this.classScope.usePrivateName(o.id.name, o.start)),
          (n.property = o),
          a && this.expect(c.bracketR),
          r.optionalChainMember
            ? ((n.optional = i), this.finishNode(n, 'OptionalMemberExpression'))
      ...
      parseTaggedTemplateExpression(t, e, s, r) {
        ...
        return (
          ...
          r.optionalChainMember && this.raise(e, g.OptionalChainingNoTemplate),
      ...
      parseCallExpressionArguments(t, e, s, r, i) {
        ...
        return (
          e && a && this.shouldParseAsyncArrow() && this.unexpected(),
        ...
        switch (this.state.type) {
          ...
          case c.name: {
            ...
            if (!t && 'async' === s.name && !this.canInsertSemicolon()) {
              if (this.match(c._function)) {
                ...
                if (this.state.context[t] !== T.functionStatement)
                  throw new Error('Internal error');
                return (
                  (this.state.context[t] = T.functionExpression),
                  this.next(),
          ...
          case c.bracketHashL:
            return this.parseArrayLike(
              this.state.type === c.bracketBarL ? c.bracketBarR : c.bracketR,
              !1,
              !0,
              t,
            );
          ...
          case c.hash: {
            ...
            if (L(t) || 92 === t) {
              const t = this.state.start;
              if (((s = this.parseMaybePrivateName(!0)), this.match(c._in)))
      ...
      parseSuper() {
        ...
        return (
          ...
          this.match(c.parenL) ||
            this.match(c.bracketL) ||
            this.match(c.dot) ||
            this.raise(t.start, g.UnsupportedSuper),
      ...
      parseMetaProperty(t, e, s) {
        ...
        return (
          ...
          (t.property.name !== s || r) &&
            this.raise(t.property.start, g.UnsupportedMetaProperty, e.name, s),
      ...
      parseParenAndDistinguishExpression(t) {
        ...
        return (
          (E.expression = r), this.finishNode(E, 'ParenthesizedExpression'), E
        );
      }
      shouldParseArrow() {
      ...
      parseObjPropValue(t, e, s, r, i, n, a, o) {
        const u =
          this.parseObjectMethod(t, r, i, n, a) ||
          ...
          (this.state.labels = []),
            ...
            (t.body = this.parseBlock(!0, !1, i => {
              ...
              this.checkParams(t, !(this.state.strict || e || s || n), e, a),
                this.state.strict &&
                  t.id &&
                  this.checkLVal(t.id, 65, void 0, 'function name', void 0, a);
            })),
            this.prodParam.exit(),
            this.expressionScope.exit(),
            (this.state.labels = i);
      ...
      parseExprListItem(t, e, s, r) {
        let i;
        if (this.match(c.comma))
          t || this.raise(this.state.pos, g.UnexpectedToken, ','), (i = null);
          ...
          this.expectPlugin('partialApplication'),
            r || this.raise(this.state.start, g.UnexpectedArgumentPlaceholder);
          const t = this.startNode();
      ...
      parseDecorators(t) {
        ...
        if (this.match(c._export))
          ...
          throw this.raise(this.state.start, g.UnexpectedLeadingDecorator);
      }
      parseDecorator() {
      ...
      parseTryStatement(t) {
        ...
        return (
          ...
          t.handler || t.finalizer || this.raise(t.start, g.NoCatchOrFinally),
        ...
        if (
          ...
          this.withTopicForbiddingContext(() => {
            for (; !this.match(c.braceR); ) {
              if (this.eat(c.semi)) {
                if (r.length > 0)
                  throw this.raise(this.state.lastTokEnd, g.DecoratorSemicolon);
                continue;
              }
              if (this.match(c.at)) {
      ...
      parseClassProperty(t) {
        return (
          (t.typeAnnotation && !this.match(c.eq)) ||
      ...
      isAsyncFunction() {
        ...
        const t = this.nextTokenStart();
        return (
          !m.test(this.input.slice(this.state.pos, t)) &&
          ...
          if (s) {
            if (
              ...
              'Identifier' !== e.type ||
                'from' !== e.name ||
                e.end - e.start != 4 ||
                (null == (i = e.extra) ? void 0 : i.parenthesized) ||
            ...
            for (let e = 0, s = t.specifiers; e < s.length; e++) {
              ...
              if ((this.checkDuplicateExports(t, n), !r && t.local)) {
                const { local: e } = t;
                'StringLiteral' === e.type
                  ? this.raise(t.start, g.ExportBindingIsString, e.extra.raw, n)
      ...
      parseImport(t) {
        if (((t.specifiers = []), !this.match(c.string))) {
          const e =
              !this.maybeParseDefaultImportSpecifier(t) || this.eat(c.comma),
      ...
      parseAssertEntries() {
        ...
        do {
          ...
          if (
            ...
            this.expect(c.colon),
            'type' !== r &&
              this.raise(s.key.start, g.ModuleAttributeDifferentFromType, r),
            e.has(r) &&
              this.raise(s.key.start, g.ModuleAttributesWithDuplicateKeys, r),
            e.add(r),
            !this.match(c.string))
          )
            throw this.unexpected(
      ...
      maybeParseModuleAttributes() {
        if (!this.match(c._with) || this.hasPrecedingLineBreak())
